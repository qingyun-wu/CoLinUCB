...
if __name__ == '__main__':
	...
	for p_art in poolArticles:
		...
		algorithmsBaselines['LinUCB'] = LinUCBAlgorithm(dimension = dimension, alpha = alpha, lambda_ = lambda_, n = n_users)
		#algorithmsBaselines['Exp3'] = Exp3Algorithm(dimension = dimension, gamma =gamma)
		#algorithmsBaselines['UCB1'] = UCB1Algorithm(dimension = dimension)
		#algorithmsBaselines['epsilon-Greedy'] = EpsilonGreedyAlgorithm(dimension = dimension, epsilon = epsilon)
		#simExperiment.runCoLinUCB(algorithmsCoLinUCB)
		#simExperiment.runLinUCB(algorithmsBaselines)
